...
>代码获取地址：[https://mbd.pub/o/bread/YZWbk5lxaw==](https://mbd.pub/o/bread/YZWbk5lxaw==)
...
本项目旨在构建一套**高精度、智能化、端到端**的舰船识别系统。通过结合目标检测技术（**YOLOv8**）与多模态大语言模型（**LLaVA**），不仅实现对海面舰船的实时定位与计数，还能对目标进行深层次的特征描述与态势评估，从而实现从“看得见”到“看得懂”的智能化跨越。
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/5b0d28961f2e41c481b87323a670060e.png#pic_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/d1b453e611b8407e83039ab51dbaea5d.png#pic_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/b52b707134974801a63643ceb7660ee3.png#pic_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/a86f867d825c457f927bb21e6ec5bc59.png#pic_center)
![在这里插入图片描述](https://i-blog.csdnimg.cn/direct/001d49e3614a418ba0710eea33821e94.png#pic_center)
